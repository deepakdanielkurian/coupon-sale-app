    ...
    <div style={{ background:"#f5f7f5", padding:"10px 12px 28px" }}>
      ...
      {can.viewLogs() && (
        <Section title="Admin tools">
          ...
          <Row icon="ti-users-group" iconBg="#f3e5f5" iconColor="#4a148c" label="Ticket Supporters" sub="Recognition list for the report" badge={`${shareholders?.length||0}`} onClick={()=>onSubScreen("shareholders")}/>
